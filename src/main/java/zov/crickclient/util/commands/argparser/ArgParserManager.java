...
package zov.crickclient.util.commands.argparser;

import zov.crickclient.util.commands.api.argparser.IArgParser;
...
import zov.crickclient.util.commands.api.exception.CommandNoParserForTypeException;
