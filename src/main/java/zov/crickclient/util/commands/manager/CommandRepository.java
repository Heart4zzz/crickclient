package zov.crickclient.util.commands.manager;
...
import zov.crickclient.util.commands.api.exception.CommandUnhandledException;
import zov.crickclient.util.commands.api.exception.ICommandException;
...
import zov.crickclient.util.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(CrickClient.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
