...
import zov.crickclient.event.list.ChatEvent;
import zov.crickclient.event.list.TabCompleteEvent;
import zov.crickclient.util.commands.api.argument.ICommandArgument;
import zov.crickclient.util.commands.api.exception.CommandNotEnoughArgumentsException;
import zov.crickclient.util.commands.api.exception.CommandNotFoundException;
import zov.crickclient.util.commands.api.helpers.TabCompleteHelper;
import zov.crickclient.util.commands.api.manager.ICommandManager;
import zov.crickclient.util.commands.argument.ArgConsumer;
import zov.crickclient.util.commands.argument.CommandArguments;
import zov.crickclient.util.commands.manager.CommandRepository;

import java.util.List;
import java.util.stream.Stream;

import static zov.crickclient.util.commands.api.IBaritoneChatControl.FORCE_COMMAND_PREFIX;
...
public class CommandDispatcher {
    ...
    public CommandDispatcher() {
        this.manager = CrickClient.getInstance().getCommandRepository();
