...
package zov.crickclient.util.commands.argument;
...
import zov.crickclient.util.commands.api.datatypes.IDatatype;
import zov.crickclient.util.commands.api.datatypes.IDatatypeContext;
import zov.crickclient.util.commands.api.datatypes.IDatatypeFor;
import zov.crickclient.util.commands.api.datatypes.IDatatypePost;
...
import zov.crickclient.util.commands.api.exception.CommandTooManyArgumentsException;
