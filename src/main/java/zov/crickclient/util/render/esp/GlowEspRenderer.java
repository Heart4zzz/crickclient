package zov.crickclient.util.render.esp;
...
import zov.crickclient.mixin.LivingEntityRendererAccessor;
import zov.crickclient.module.list.render.GlowEsp;
...
public class GlowEspRenderer {
    ...
    private void renderSilhouette(MatrixStack matrices, PlayerEntity player, float tickDelta) {
        ...
        accessor.crickclient$setupTransforms(state, matrices, state.bodyYaw, scale);
        accessor.crickclient$scale(state, matrices);
