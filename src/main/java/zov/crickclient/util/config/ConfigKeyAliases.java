...
final class ConfigKeyAliases {
    private static final List<List<String>> ALIAS_GROUPS = List.of(
            ...
            // NoSlow: старый одиночный режим "Мод" переезжает в "Основная рука".
            List.of("Основная рука", "Мод"),
            // ServerJoiner: настройки переименованы вместе с новой логикой модуля.
            List.of("Выберите сервер", "Сервер"),
