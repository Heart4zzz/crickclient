package zov.crickclient.util.draggable;
...
public class Draggable implements IMinecraft {
    ...
    // Покачивание («качели») при перетаскивании
    private float wobbleAngle, wobbleVel, prevX;
    ...
    // Покачивание («качели») отключено — элемент двигается без наклона.
