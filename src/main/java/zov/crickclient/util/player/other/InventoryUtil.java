package zov.crickclient.util.player.other;
...
import zov.crickclient.module.list.movement.Sprint;
...
public class InventoryUtil implements IMinecraft {
    ...
    public static void swapWithBypassGrim(Runnable runnable) {
        ...
        try {
            ...
            if (CrickClient.getInstance().getServerManager().isServerSprinting()) {
