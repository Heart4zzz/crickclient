...
import zov.crickclient.event.list.EventCobweb;
...
@ModuleInformation(moduleName = "No Web", moduleDesc = "Отменяет замедление в паутине", moduleCategory = ModuleCategory.MOVEMENT)
