...
@ModuleInformation(moduleName = "HitBubbles", moduleDesc = "Круг при ударе игрока", moduleCategory = ModuleCategory.RENDER)
public class HitBubbles extends Module {
    ...
    private final Identifier bubbleTexture = Identifier.of("mre", "images/bubble.png");
    ...
    public void onAttack(EventAttack event) {
        ...
        Vec3d sideDir = getHitSideDirection(living, mc.player.getPos());
    ...
    private void renderSingleBubble(MatrixStack stack, Vec3d cameraPos, HitBubble bubble, long now) {
        ...
        int color = multAlpha(getThemeColor(), alpha);
    ...
    private int multAlpha(int color, float alphaMultiplier) {
        int a = (color >> 24) & 0xFF;
        int r = (color >> 16) & 0xFF;
        int g = (color >> 8) & 0xFF;
        int b = color & 0xFF;
