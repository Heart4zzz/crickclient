...
public class TargetESP extends Module {
    ...
    private void onRenderWorldLast(MatrixStack matrices, Camera camera, float tickDelta) {
        ...
        Entity target = CrickClient.getInstance().getModuleStorage().get(KillAura.class).getTarget();
    ...
    private void drawGhosts2(MatrixStack matrices, float tickDelta) {
        ...
        KillAura killAura = CrickClient.getInstance().getModuleStorage().get(KillAura.class);
