...
import zov.crickclient.module.list.combat.AntiBot;
...
import zov.crickclient.util.render.lines.VertexUtil;
...
@ModuleInformation(moduleName = "Tracers", moduleDesc = "Линии до игроков и сущностей", moduleCategory = ModuleCategory.RENDER)
public class Tracers extends Module {
    ...
    private boolean isValid(Entity entity) {
        ...
        if (entity instanceof PlayerEntity p) {
            if (CrickClient.getInstance().getModuleStorage().get(AntiBot.class).isBot(p)) return false;
