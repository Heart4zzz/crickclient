...
import zov.crickclient.util.render.builders.Builder;
...
import zov.crickclient.util.render.math.ProjectionUtil;
...
public class NameTags extends Module {
    ...
    public static Text processName(PlayerEntity entity) {
        ...
        NameProtect nameProtect = CrickClient.getInstance().getModuleStorage().get(NameProtect.class);
    ...
    private void renderPlayerTags(MsdfFont font, float tickDelta, EventHUD e) {
        ...
        Interface iface = CrickClient.getInstance().getModuleStorage().get(Interface.class);
        ...
        for (PlayerEntity entity : worldPlayers) {
            ...
            float currentHp = zov.crickclient.util.server.Server.getHealth(entity, false);
            ...
            name.append(Text.literal(" - ").setStyle(Style.EMPTY.withColor(Formatting.GRAY)))
                    .append(Text.literal(zov.crickclient.util.server.Server.formatHealthDisplay(currentHp)).setStyle(Style.EMPTY.withColor(hpColor)))
