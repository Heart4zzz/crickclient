...
public class Module implements IMinecraft, QuickLogger {
    ...
    public void onDisable() {
        CrickClient.getInstance().getEventBus().unregister(this);
    }
